...
#    monitor=,preferred,auto,1
   monitor=,highres,auto,1
    ...
    exec = swaybg -m fill -i  ~/Pictures/wallpaperflare.com_wallpaper2.jpg
    exec-once = nm-applet
    exec-once = hyprpaper
    exec-once = waybar
    ...
    exec-once = swaync
    exec-once = fcitx5
    #exec-onee = /etc/xdg/autostart/polkit-gnome-authentication-agent-1
    #exec-once = spotifyd
...
#bind = SUPER, D, exec, killall rofi || rofi -modi drun,run -show drun -theme ~/.config/rofi/global/rofi.rasi
